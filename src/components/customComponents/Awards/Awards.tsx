...
const Award = () => {
  ...
  <div className="flex items-center gap-4">
    ...
    />
            ...
            {/* Center Section */}
            <div className="flex flex-col text-center sm:text-left mx-40 z-10 mt-4 sm:mt-0"> {/* Added mx-auto, removed sm:ml-8 sm:mr-auto */}
              <h2 className="text-[#000000] text-[20px] sm:text-2xl md:text-3xl px-2 sm:px-4 font-bold  leading-tight text-center">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-10 -top-4">
              <div className="relative   border-white">
                <img
                  className='relative w-[120px] h-[120px] sm:w-[150px] sm:h-[150px]  object-cover'
