  ...
  return (
    <div className="relative min-h-screen bg-black">
      ...
      <div className="w-full text-center py-4">
        ...
        <p className={`{text-white text-lg text-Uppercase ${poppins.className}`}>Learn & Develop a Levek Of Project Which You Can't Find Anywhere – Internet / Google / Chatgpt</p>
      </div>
